...
def _image_buffer_data_type(
  ...
  if data_type == image_buffer_pb2.DataType.TYPE_UINT8:
    return np.uint8
  elif data_type == image_buffer_pb2.DataType.TYPE_UINT16:
    return np.uint16
  elif data_type == image_buffer_pb2.DataType.TYPE_UINT32:
    return np.uint32
  elif data_type == image_buffer_pb2.DataType.TYPE_INT8:
    return np.int8
  elif data_type == image_buffer_pb2.DataType.TYPE_INT16:
    return np.int16
  elif data_type == image_buffer_pb2.DataType.TYPE_INT32:
    return np.int32
  elif data_type == image_buffer_pb2.DataType.TYPE_FLOAT32:
    return np.float32
  elif data_type == image_buffer_pb2.DataType.TYPE_FLOAT64:
    return np.float64
  else:
...
def serialize_image_buffer(
  ...
  if image_array.dtype == np.uint8:
    data_type = image_buffer_pb2.DataType.TYPE_UINT8
  elif image_array.dtype == np.uint16:
    data_type = image_buffer_pb2.DataType.TYPE_UINT16
  elif image_array.dtype == np.uint32:
    data_type = image_buffer_pb2.DataType.TYPE_UINT32
  elif image_array.dtype == np.int8:
    data_type = image_buffer_pb2.DataType.TYPE_INT8
  elif image_array.dtype == np.int16:
    data_type = image_buffer_pb2.DataType.TYPE_INT16
  elif image_array.dtype == np.int32:
    data_type = image_buffer_pb2.DataType.TYPE_INT32
  elif image_array.dtype == np.float32:
    data_type = image_buffer_pb2.DataType.TYPE_FLOAT32
  elif image_array.dtype == np.float64:
    data_type = image_buffer_pb2.DataType.TYPE_FLOAT64
  else:
