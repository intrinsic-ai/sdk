...
def main():
  args = parse_args()
  assert 'name = "grpc", version = "1.72.0"' in args.module_bazel.read_text()
  assert "grpcio==1.72.1" in args.requirements_in.read_text()
  assert "grpcio==1.72.1" in args.requirements_txt.read_text()
